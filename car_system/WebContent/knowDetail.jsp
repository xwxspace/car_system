...
<body onselectstart="return true;" ondragstart="return false;">
	...
	<div class="body" style="padding-bottom: 60px;">
		...
		<div class="top_bar">
			...
			<div class="nav_10">
				<ul class="box">
					...
					<li><a href="addKnow.jsp">
							<p class="share"></p> <span>撰写知道</span>
					</a></li>
				</ul>
			</div>
			</section>
		...
		<h3 style="font-size: 14px;">汽车知道</h3>
		...
		<c:forEach items="${knowList }" var="know">
			<p>
				<a href="queryKnowById?id=${know.knowid }">
			...
			<p>
				${fn:substring(know.knowtext, 0, 50) }
				<a href="queryKnowById?id=${know.knowid }">>>></a>
			</p>
			<p>
				<br />
			</p>
