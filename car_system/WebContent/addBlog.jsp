...
<body id="onlinebooking">
	...
	<form action="addBlogAction" method="post">
		<ul class="round">
			<li class="title mb"><span class="none">请写下您的经历</span></li>
			<li class="nob">
				<table class="kuang" border="0" cellpadding="0" cellspacing="0"
					width="100%">
					<tr>
						<th>标题</th>
						<td><input name="blogtitle" class="px" id="tel" value=""
							placeholder="请再输入您的标题" type="text"></td>
					</tr>
				</table>
			</li>
			...
			<li class="nob">
				<table class="kuang" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>
							<textarea name="blogtext" class="pxtextarea" style="height: 299px; overflow-y: visible" id="info" placeholder="请输入信息" ></textarea>
							<input type="hidden" name="username" id="aid" value="${username }" />
						</td>
					</tr>
				</table>
			</li>
		...
		<div class="footReturn">
			<input id="showcard" class="submit" value="分享博客" type="submit" style="width: 100%;" />
			<div class="window" id="windowcenter">
				<div id="title" class="wtitle">
					分享博客<span class="close" id="alertclose"></span>
				</div>
				<div class="content">
					<div id="txt"></div>
				</div>
