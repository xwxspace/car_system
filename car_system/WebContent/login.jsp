...
<body id="onlinebooking">
	...
	<form action="loginAction" method="post">
		<ul class="round">
			...
			<li class="nob">
				<table class="kuang" border="0" cellpadding="0" cellspacing="0"	width="100%">
					<tr>
						<th>用户名</th>
						<td><input name="username" class="px" id="tel" value=""
							placeholder="请输入您的用户名" type="text"></td>
					</tr>
				</table>
			</li>
			<li class="nob">
				<table class="kuang" border="0" cellpadding="0" cellspacing="0"	width="100%">
					<tr>
						<th>密码</th>
						<td><input name="password" class="px" id="tel" value=""
		...
		<div class="footReturn">
			<input style="width: 100%;" id="showcard" class="submit" value="确认登陆" type="submit" />
			<div class="window" id="windowcenter">
				<div id="title" class="wtitle">
					确认登陆<span class="close" id="alertclose"></span>
				</div>
				<div class="content">
					<div id="txt"></div>
				</div>
